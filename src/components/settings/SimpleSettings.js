...
export default function SimpleSettings() {
  ...
  return (
    <>
      ...
      {/* {!open && <SimpleToggleButton open={open} notDefault={notDefault} onToggle={handleToggle} />} */}
      <SimpleToggleButton open={open} notDefault={notDefault} onToggle={handleToggle} />
              ...
              <Scrollbar sx={{ flexGrow: 1 }}>
                <Stack spacing={3} sx={{ p: 3 }}>
                  ...
                  <Stack spacing={1.5}>
                    ...
                    <Typography variant="subtitle2">Acento</Typography>
                    <SettingColorPresets />
                  </Stack>
