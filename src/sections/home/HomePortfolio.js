...
const CARDS = [
  {
    ...
    iconAlternative: '/images/portfolio/farmaReyes.jpg',
  ...
  {
    id: 1,
    icon: '/images/portfolio/transporte1.png',
    iconAlternative: '/images/portfolio/transporte1.png',
  ...
  {
    id: 2,
    icon: '/images/portfolio/SistemadeLlenado.png',
    iconAternative: '/images/portfolio/SistemaDeLlenado1.png',
  ...
  {
    id: 3,
    icon: '/images/portfolio/AutoEat1.png',
    iconAlternative: '/images/portfolio/AutoEat2.jpg',
    title: 'Auto Eat',
